...
UNIT_DATA = {
    # --- Tier 1 (평균 DPS ~15) ---
    'slayer_basic': {'tier': 1, 'dmg': 15, 'speed': 1000},
    'crow':         {'tier': 1, 'dmg': 10, 'speed': 650},
    'kakushi':      {'tier': 1, 'dmg': 6,  'speed': 400},

    # --- Tier 2 (평균 DPS ~75) ---
    'tanjiro':  {'tier': 2, 'dmg': 60,  'speed': 800},
    'zenitsu':  {'tier': 2, 'dmg': 75,  'speed': 1000},
    'inosuke':  {'tier': 2, 'dmg': 68,  'speed': 900},
    'genya':    {'tier': 2, 'dmg': 53,  'speed': 700},
    'kanao':    {'tier': 2, 'dmg': 85,  'speed': 1100},
    'aoi':      {'tier': 2, 'dmg': 30,  'speed': 500},

    # --- Tier 3 (평균 DPS ~375) ---
    'urokodaki':  {'tier': 3, 'dmg': 345, 'speed': 920},
    'jigoro':     {'tier': 3, 'dmg': 375, 'speed': 1000},
    'haganezuka': {'tier': 3, 'dmg': 600, 'speed': 1500},
    'sabito':     {'tier': 3, 'dmg': 320, 'speed': 850},
    'nezuko_box': {'tier': 3, 'dmg': 280, 'speed': 750},
    'yushiro':    {'tier': 3, 'dmg': 338, 'speed': 900},
    'murata':     {'tier': 3, 'dmg': 265, 'speed': 700},

    # --- Tier 4 주(Hashira) (평균 DPS ~1900) ---
    'giyu':     {'tier': 4, 'dmg': 1400, 'speed': 750},
    'rengoku':  {'tier': 4, 'dmg': 1900, 'speed': 1000},
    'tengen':   {'tier': 4, 'dmg': 1500, 'speed': 800},
    'shinobu':  {'tier': 4, 'dmg': 950,  'speed': 500},
    'kanae':    {'tier': 4, 'dmg': 1250, 'speed': 670},
    'muichiro': {'tier': 4, 'dmg': 1750, 'speed': 920},
    'mitsuri':  {'tier': 4, 'dmg': 1580, 'speed': 830},
    'obanai':   {'tier': 4, 'dmg': 1650, 'speed': 870},
    'sanemi':   {'tier': 4, 'dmg': 1850, 'speed': 970},
    'gyomei':   {'tier': 4, 'dmg': 3500, 'speed': 1500},
    'tamayo':   {'tier': 4, 'dmg': 1100, 'speed': 580},

    # --- Tier 5 각성 (평균 DPS ~10000) ---
    'tanjiro_sun':    {'tier': 5, 'dmg': 6500,  'speed': 650},
    'zenitsu_god':    {'tier': 5, 'dmg': 8500,  'speed': 850},
    'nezuko_awake':   {'tier': 5, 'dmg': 5800,  'speed': 580},
    'giyu_mark':      {'tier': 5, 'dmg': 6300,  'speed': 630},
    'muichiro_mark':  {'tier': 5, 'dmg': 6000,  'speed': 600},
    'tamayo_yushiro': {'tier': 5, 'dmg': 4700,  'speed': 470},
    'inosuke_awake':  {'tier': 5, 'dmg': 6800,  'speed': 680},
    'rengoku_awake':  {'tier': 5, 'dmg': 9500,  'speed': 920},
    'tengen_score':   {'tier': 5, 'dmg': 7300,  'speed': 730},
    'shinobu_dance':  {'tier': 5, 'dmg': 11000, 'speed': 1050},
    'kanae_spirit':   {'tier': 5, 'dmg': 5500,  'speed': 550},
    'sanemi_mark':    {'tier': 5, 'dmg': 8000,  'speed': 790},
    'obanai_mark':    {'tier': 5, 'dmg': 7700,  'speed': 760},
    'mitsuri_mark':   {'tier': 5, 'dmg': 7100,  'speed': 710},
    'yoriichi_zero':  {'tier': 5, 'dmg': 4800,  'speed': 400},
    'rengoku_smile':  {'tier': 5, 'dmg': 10000, 'speed': 800},

    # --- Tier 6 신화 (평균 DPS ~56000) ---
    'tanjiro_final':       {'tier': 6, 'dmg': 47600, 'speed': 850},
    'gyomei_mark':         {'tier': 6, 'dmg': 58000, 'speed': 1000},
    'yoriichi':            {'tier': 6, 'dmg': 50400, 'speed': 900},
    'inosuke_king':        {'tier': 6, 'dmg': 19600, 'speed': 350},
    'zenitsu_7th':         {'tier': 6, 'dmg': 17100, 'speed': 300},
    'giyu_calm':           {'tier': 6, 'dmg': 53200, 'speed': 950},
    'sanemi_wind_god':     {'tier': 6, 'dmg': 43500, 'speed': 750},
    'love_snake_couple':   {'tier': 6, 'dmg': 28000, 'speed': 500},
    'muichiro_transparent':{'tier': 6, 'dmg': 82500, 'speed': 1500},
    'koku':                {'tier': 6, 'dmg': 54400, 'speed': 850},
    'tanjiro_king':        {'tier': 6, 'dmg': 29250, 'speed': 450},
    'twin_destiny':        {'tier': 6, 'dmg': 60000, 'speed': 400},
    'rengoku_legend':      {'tier': 6, 'dmg': 56700, 'speed': 900},
    'nezuko_sun':          {'tier': 6, 'dmg': 37200, 'speed': 600},
}
